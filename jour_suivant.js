...
}else if (jour.toUpperCase() === "MARDI") {
    console.log("Demain, nous serons mercredi.");
}else if (jour.toUpperCase() === "MERCREDI") {
    console.log("Demain, nous serons jeudi.");
}else if (jour.toUpperCase() === "JEUDI") {
    console.log("Demain, nous serons vendredi.");
}else if (jour.toUpperCase() === "VENDREDI") {
    console.log("Demain, nous serons samedi.");
}else if (jour.toUpperCase() === "SAMEDI") {
    console.log("Demain, nous serons dimanche.");
}else if (jour.toUpperCase() === "DIMANCHE") {
...
switch (jour) {
    ...
    case "dimanche":
        ...
        break;
    default :
        console.log("Je n'ai pas compris, rafraichis ta page et ecris correctement le jour de la semaine sans majuscule");
        break;
}*/
